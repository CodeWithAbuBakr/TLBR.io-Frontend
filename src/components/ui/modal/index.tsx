...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-20 flex items-center justify-center overflow-y-auto modal ${darkMode ? "bg-black/60" : ""
        }`}
    >
      {/* Backdrop */}
      {!isFullscreen && (
        <div
          className={`fixed inset-0 backdrop-blur-[32px] ${darkMode ? "bg-gray-800/60" : "bg-gray-400/50"
            }`}
        />
      )}
